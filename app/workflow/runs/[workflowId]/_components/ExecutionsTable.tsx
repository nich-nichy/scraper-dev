            ...
            <Table className='h-full'>
                ...
                <TableBody className='gap-2 h-full overflow-auto'>
                    {query.data.map((execution) => {
                        ...
                        return <TableRow key={execution.id} className='cursor-pointer' onClick={() => { router.push(`/workflow/runs/${execution.workflowId}/${execution.id}`) }}>
                            <TableCell>
                                <div className='flex flex-col'>
                                    ...
                                    <div className="text-muted-foreground text-xs gap-2">
                                        <span className='pr-1'>Triggered via</span>
                            ...
                            <TableCell>
                                <div className="flex-flex-col">
                                    <div className='flex gap-2 items-center'>
                                        <CoinsIcon size={14} className="stroke-primary" />
